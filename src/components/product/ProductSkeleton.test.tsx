...
describe("ProductSkeleton", () => {
  ...
  it("should render title skeleton with proper structure", () => {
    ...
    expect(titleSkeletons[0]).toHaveClass(
      "h-5",
      "bg-gray-200",
      "rounded",
      "w-full",
    ...
    expect(titleSkeletons[1]).toHaveClass(
      "h-5",
      "bg-gray-200",
      "rounded",
      "w-3/4",
  ...
  it("should render rating text skeleton", () => {
    ...
    const ratingTextSkeleton = ratingContainer?.querySelector(
  ...
  it("should render description skeleton with three lines", () => {
    ...
    // Check line widths
    expect(descriptionLines?.[0]).toHaveClass(
      "h-4",
      "bg-gray-200",
      "rounded",
      "w-full",
    );
    expect(descriptionLines?.[1]).toHaveClass(
      "h-4",
      "bg-gray-200",
      "rounded",
      "w-full",
    );
    expect(descriptionLines?.[2]).toHaveClass(
      "h-4",
      "bg-gray-200",
      "rounded",
      "w-2/3",
  ...
  it("should render price skeleton", () => {
    ...
    const priceSkeleton = container.querySelector(
  ...
  it("should position action area at bottom with mt-auto", () => {
    ...
    const priceSkeleton = actionArea?.querySelector(
      ".h-8.bg-gray-200.rounded.w-20",
    );
    const buttonSkeleton = actionArea?.querySelector(
      ".h-10.bg-gray-200.rounded.w-full",
    );
